<?php
	...
	if ($search =="all"){
			$sqlloadhomestay = "SELECT * FROM tbl_homestays ORDER BY homestay_id DESC";
	}else{
		$sqlloadhomestay = "SELECT * FROM tbl_homestays WHERE homestay_name LIKE '%$search%' ORDER BY homestay_id DESC";
	}
